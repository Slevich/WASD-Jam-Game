...
public static class ComponentsSearcher
{
    ...
    public static Component[] GetAllComponentsFromObject(UnityEngine.Object ComponentHolder)
    {
    ...
    public static Component GetComponentFromObject (UnityEngine.Object ComponentHolder, Type ComponentType)
    {
    ...
    public static Component[] GetComponentsFromObject (UnityEngine.Object ComponentHolder, Type[] SearchingTypes)
    {
