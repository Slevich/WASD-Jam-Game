...
public class TimeStagesExecutor : MonoBehaviour
{
    ...
    [SerializeField, HideInInspector] public int NumberOfStages => _stages != null ? _stages.Length : 0;
    ...
    {
        int index = Array.IndexOf(_stages, singleStage);
    ...
    private int DefineCurrentStageIndex(float currentTime)
    {
        ...
        int index = Array.IndexOf( _stages, leftStages.First());
        return index;
    }
